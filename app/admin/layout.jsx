        ...
        <div>
            ...
            <div className='absolute bg-primary h-full w-48 pt-24 z-10 text-white font-semibold'>
                ...
                <ul className='flex-col'>
                    <Link href="/admin/pelatihan" className={`py-4 border-t block px-3 ${pathName === "/admin/pelatihan" ? "bg-yellow-400" : ""}`}>
                        <li className='flex justify-between'>
                            <p>Pelatihan</p>
                            <img src="/icons/triangle.svg" alt="" className='w-5 rotate-90' />
                        </li>
                    </Link>
                    <Link href="/admin/informasi-periode" className='py-4 border-y block px-3'>
                        <li className='flex justify-between'>
                            <p>Informasi Periode</p>
                            <img src="/icons/triangle.svg" alt="" className='w-5 rotate-90' />
                        </li>
                    </Link>
                    <Link href="/admin/jadwal" className='py-4 border-b block px-3'>
                        <li className='flex justify-between'>
                            <p>Jadwal</p>
                            <img src="/icons/triangle.svg" alt="" className='w-5 rotate-90' />
                        </li>
