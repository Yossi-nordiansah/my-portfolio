            ...
            {schedules.map((item, idx) => (
              <tr key={idx}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <button className="inline-flex text-white bg-[#00e673] items-center mr-3 bg-green-400 px-2.5 py-1.5 border border-gray-300 text-xs font-medium rounded hover:bg-green-300">
