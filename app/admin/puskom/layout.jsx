        ...
        <div>
            ...
            <div className='absolute bg-primary h-full w-48 pt-24 z-10 text-white font-semibold'>
                ...
                <ul className='flex-col'>
                    ...
                    <Link href="/admin/puskom/informasi-periode" className={`py-4 border-b block px-3 ${pathName === "/admin/puskom/informasi-periode" ? "bg-yellow-400" : ""}`}>
                        <li className='flex justify-between'>
                            <p>Informasi Periode</p>
                            <img src="/icons/triangle.svg" alt="" className='w-5 rotate-90' />
                        </li>
                    </Link>
                    <Link href="/admin/puskom/jadwal" className={`py-4 border-b block px-3 ${pathName === "/admin/puskom/jadwal" ? "bg-yellow-400" : ""}`}>
                        <li className='flex justify-between'>
                            <p>Jadwal</p>
                            <img src="/icons/triangle.svg" alt="" className='w-5 rotate-90' />
                        </li>
                    </Link>
                    <Link href="/admin/puskom/cetak-laporan" className={`py-4 border-b block px-3 ${pathName === "/admin/puskom/cetak-laporan" ? "bg-yellow-400" : ""}`}>
                        <li className='flex justify-between'>
                            <p>Cetak Laporan</p>
                            <img src="/icons/triangle.svg" alt="" className='w-5 rotate-90' />
                        </li>
                    </Link>
                    <Link href="/admin/puskom/instruktur" className={`py-4 border-b block px-3 ${pathName === "/admin/puskom/instruktur" ? "bg-yellow-400" : ""}`}>
                        <li className='flex justify-between'>
                            <p>Instruktur</p>
                            <img src="/icons/triangle.svg" alt="" className='w-5 rotate-90' />
                        </li>
