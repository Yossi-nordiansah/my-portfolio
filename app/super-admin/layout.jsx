...
const AdminLayout = ({ children }) => {
    ...
    return (
        <div>
            ...
            <div className='absolute bg-primary min-h-screen w-48 pt-24 z-10 text-white font-semibold'>
                ...
                <ul className='flex-col'>
                    ...
                    <Link href="/super-admin/puskom/instruktur" className={`py-4 border-b block px-3 ${pathName === "/super-admin/puskom/admin" ? "bg-yellow-400" : ""}`}>
                        <li className='flex justify-between'>
                            <p>Admin</p>
                            <img src="/icons/triangle.svg" alt="" className='w-5 rotate-90' />
                        </li>
